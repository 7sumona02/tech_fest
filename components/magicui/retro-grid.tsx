...
export default function RetroGrid({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 [transform:rotateX(35deg)]">
        <div
          className={cn(
            ...
            // Light Styles
            "[background-image:linear-gradient(to_right,rgba(255,255,255,0.9)_1px,transparent_0),linear-gradient(to_bottom,rgba(255,255,255,0.3)_1px,transparent_0)]",
      ...
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-t from-black   via-transparent to-purple-700 to-70%  dark:from-black" />
    </div>
  );
}
