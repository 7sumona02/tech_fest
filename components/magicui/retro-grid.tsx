      ...
      <div className="absolute inset-0 [transform:rotateX(35deg)]">
        <div
          className={cn(
            ...
            // Dark styles
            "dark:[background-image:linear-gradient(to_right,rgba(255,255,255,1)_1px,transparent_0),linear-gradient(to_bottom,rgba(255,255,255,1)_1px,transparent_0)] dark:[background-color:black]",
          )}
        />
      </div>
